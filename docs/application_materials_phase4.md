...
## 2. Short Title
**NeuroMitoMap (MitoMet-POCD) — Conservative Module Audit**
...
- Findings should be treated as **hypothesis-generating only**.
- Cross-dataset agreement is reported conservatively (for example, partial rank-level or limited directional concordance where applicable).
- Annotation limits are explicitly documented and treated as interpretation constraints.
- Random-control sensitivity QC is used to assess robustness boundaries, not to claim definitive validation.
- The project is **not suitable for strong mechanistic inference**.

## 8. Dangerous Claims to Avoid
Avoid language that implies:
- proven mechanism or causal pathway
- therapeutic target identification
- robust biomarker discovery or validation
- clinical relevance or translational readiness
- high-confidence disease-driving biology
